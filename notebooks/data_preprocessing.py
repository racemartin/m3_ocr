...
class DataCleaner:
    ...
    def __init__(self, df: pd.DataFrame, verbose: bool = True):
        ...
        self.COLS_CONSTANT            = [] # AUTO: self.constant_columns_analysis(df)
        self.COLS_MISSING_EXCESIF     = ['Outlier'];     # 'Comments', 
        self.COLS_IDENTIFIANTS        = ['OSEBuildingID']
        self.COLS_REDONDANTS          = ['Electricity(kWh)', 'NaturalGas(therms)'];
        self.COLS_TO_DROP             = []  # Columnas constantes o identificadores
    ...
    def analyser_pour_ohe(self, col: str):
        ...
        if n_uniques > 15:
            ...
            print(f"Le OHE va créer beaucoup de colonnes. Envisagez de regrouper les catégories rares.")
        else:
        ...
        if results.get('candidats_suppression'):
            ...
            if auto_eliminer:
                ...
                if self.verbose:
                    ...
                    print(f"ℹ️ Elles seront conservées pendant le FIT et supprimées lors du TRANSFORM.")
        else:
            if self.verbose:
    ...
    def fit(self, df):
        ...
        if self.verbose:
            ...
            print(f"🚀 [Fit] PROCESO COMPLETO. El objeto FeatureEngineer está listo.")
